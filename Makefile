#############################################################################
# Makefile for building: tiny_photo_processer
# Generated by qmake (3.0) (Qt 5.0.2) on: ?? 11? 17 18:29:08 2013
# Project:  tiny_photo_processer.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile tiny_photo_processer.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-64 -I. -I/usr/local/include/opencv2 -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /usr/local/lib/*.so -lQt5Widgets -L/usr/lib/x86_64-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		tiny_photo_processer.pro \
		tiny_photo_processer.pro
QMAKE_TARGET  = tiny_photo_processer
DESTDIR       = 
...
Makefile: tiny_photo_processer.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile tiny_photo_processer.pro
...
dist: 
	@test -d .tmp/tiny_photo_processer1.0.0 || mkdir -p .tmp/tiny_photo_processer1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/tiny_photo_processer1.0.0/ && $(COPY_FILE) --parents mainwindow.h imgEditor.hpp awb.hpp IWarp.hpp .tmp/tiny_photo_processer1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/tiny_photo_processer1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/tiny_photo_processer1.0.0/ && (cd `dirname .tmp/tiny_photo_processer1.0.0` && $(TAR) tiny_photo_processer1.0.0.tar tiny_photo_processer1.0.0 && $(COMPRESS) tiny_photo_processer1.0.0.tar) && $(MOVE) `dirname .tmp/tiny_photo_processer1.0.0`/tiny_photo_processer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/tiny_photo_processer1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_imgEditor.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_imgEditor.cpp
moc_mainwindow.cpp: /usr/include/qt5/QtWidgets/QFileDialog \
...
moc_imgEditor.cpp: /usr/include/qt5/QtGui/QtGui \
		...
		imgEditor.hpp
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) imgEditor.hpp -o moc_imgEditor.cpp
...
moc_imgEditor.o: moc_imgEditor.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_imgEditor.o moc_imgEditor.cpp
